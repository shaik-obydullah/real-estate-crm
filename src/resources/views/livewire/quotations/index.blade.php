            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            <input type="checkbox" wire:model.live="selected" value="{{ $quotation->id }}" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        </td>
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">Delete {{ count($selected) }} Quotations</h3>
                </div>
                <p class="text-sm text-gray-500">Are you sure you want to delete the {{ count($selected) }} selected quotations? This action cannot be undone.</p>
                <div class="flex justify-end gap-3">
