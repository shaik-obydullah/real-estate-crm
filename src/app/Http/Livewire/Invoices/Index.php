...
class Index extends Component
{
    ...
    protected $listeners = ['invoiceDeleted' => '$refresh'];
    ...
    {
        if ($this->selectAll) {
            $this->selected = $this->invoicesQuery()->pluck('id')->toArray();
        } else {
            $this->selected = [];
        }
    }
    ...
    public function deleteSelected(): void
    {
        ...
        if ($count > 0) {
            ...
            $this->dispatch('invoiceDeleted');
            session()->flash('success', $count . ' invoice(s) deleted successfully.');
        }
    }
    ...
    public function render()
    {
        return view('livewire.invoices.index', [
            'invoices' => $this->invoicesQuery()->paginate(15),
